...
public:
	...
	{
		char MikeMendoza[4] = "";
		StringCchPrintf( MikeMendoza, 4, "%03d", nKey );
		return getflag ( section, MikeMendoza, nIDX, nSIZE, VALUE );
	}
	...
	bool getflag<bool> ( const STRING section, const int nKey, const int nIDX, const int nSIZE, bool &bVALUE )
	{
		char MikeMendoza[4] = "";
		StringCchPrintf( MikeMendoza, 4, "%03d", nKey );
		return getflag ( section, MikeMendoza, nIDX, nSIZE, bVALUE );
	}
	...
	bool getflag<float> ( const STRING section, const int nKey, const int nIDX, const int nSIZE, float &fVALUE )
	{
		char MikeMendoza[4] = "";
		StringCchPrintf( MikeMendoza, 4, "%03d", nKey );
		return getflag ( section, MikeMendoza, nIDX, nSIZE, fVALUE );
	}
	...
	bool getflag<STRING> ( const STRING section, const int nKey, const int nIDX, const int nSIZE, STRING &strVALUE )
	{
		char MikeMendoza[4] = "";
		StringCchPrintf( MikeMendoza, 4, "%03d", nKey );
		return getflag ( section, MikeMendoza, nIDX, nSIZE, strVALUE );
	}
	...
	bool getflag_sz ( const STRING section, const int nKey, const int nIDX, const int nSIZE, TCHAR* szVALUE, int nStrLen )
	{
		...
		char MikeMendoza[4] = "";
		StringCchPrintf( MikeMendoza, 4, "%03d", nKey );
		return getflag_sz ( section, MikeMendoza, nIDX, nSIZE, szVALUE, nStrLen );
	}
};
