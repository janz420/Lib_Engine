...
namespace SUBPATH
{
	...
	TCHAR SAVE_ROOT[MAX_PATH]			= _T("\\Logs\\");
	TCHAR PLAYINFO_ROOT[MAX_PATH]		= _T("\\Logs\\PlayInfo\\");
	TCHAR DEBUGINFO_ROOT[MAX_PATH]		= _T("\\Logs\\ErrorLog\\");
	TCHAR CAPTURE[MAX_PATH]				= _T("\\Logs\\ScreenShot\\");
	TCHAR CHATLOG[MAX_PATH]				= _T("\\Logs\\ChatLog\\");
